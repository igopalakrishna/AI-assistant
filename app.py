...
def talker(message):
    ...
    # return output_path  # ✅ Return file for playback
...
def handle_audio(audio_file, history):
    ...
    if audio_file is not None:
        try:
            ...
            # audio_output = talker(reply)  # ✅ Get the generated audio file
            # return history, audio_output  # ✅ Return both chat history and audio file
